                ...
                if (password.equals(rightPassword)) {
                    ...
                    while (garbage == true){
                        ...
                        switch (command1) {
                            ...
                            case 3: {
                                System.err.println("В каком канале вы хотите изменить расписание?");
                                String channelName = scanner.next();
                                System.err.println("Введите имя программы, которую хотите вставить в расписание");
                                String newName = scanner.next();
                                System.err.println("Введите временной промежуток через пробел");
                                int timings[] = new int[2];
                                timings[0] = scanner.nextInt();
                                timings[1] = scanner.nextInt();
                                tv.changeProgram(channelName, newName, timings);
                            }
